...
} from "/build/_shared/chunk-IHE2A5ON.js";
import {
...
var LooksComp = ({ looks }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "looks", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 sm:grid-cols-4 md:px-4 pb-4 lg:px-24", children: products.map((product) => {
...
//# sourceMappingURL=/build/routes/($locale)._index-RSILCK2W.js.map
