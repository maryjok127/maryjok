...
} from "/build/_shared/chunk-AI3XYOH2.js";
...
var require_slider = __commonJS({
  "node_modules/react-slick/lib/slider.js"(exports) {
    ...
    var Slider5 = exports["default"] = /* @__PURE__ */ function(_React$Component) {
...
var GiftingCollection = ({ collections, title }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "recommended_section w-full max-w-screen-xl mx-auto lg:px-24 sm:px-4 md:px-6", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "relative mb-8", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react_slick.default, { ...settings, children: collections.map((coll, index2) => {
...
var Testimonials = ({ page, isSmall }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "wrapper w-full text-center mb-8", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("ul", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_react_slick3.default, { ...settings, children: context.map((content, index2) => {
      return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("li", { className: "flex gap-4 justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "shadow-xl p-4", dangerouslySetInnerHTML: { __html: content } }, void 0, false, {
        fileName: "app/components/Testimonials.jsx",
        lineNumber: 51,
        columnNumber: 21
      }, this) }, `testimonials_${index2}`, false, {
        fileName: "app/components/Testimonials.jsx",
        lineNumber: 50,
        columnNumber: 24
      }, this);
...
function Homepage() {
  ...
  collectionArray.map((col, index2) => {
    let collNodes = data.collections.nodes;
    collectionArray[index2]["image"] = { "url": noImg };
    collNodes.map((item) => {
      if (item.title.trim() === col.title.trim()) {
        let isImg = item.image?.url;
        collectionArray[index2]["handle"] = col.title.toLowerCase();
        collectionArray[index2]["image"] = { "url": isImg ? isImg : noImg };
      }
      ;
    });
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "home", children: [
    isSmall ? /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("section", { className: "collectionContent lg:hidden block sm:mt-4 overflow-auto ", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "inline-flex gap-4", children: collectionArrayStatic?.map((item, index2) => /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
      "div",
      {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "slider-container mb-8 max-w-screen-xl mx-auto lg:px-16 sm:px-4 md:px-6", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(import_react_slick4.default, { ...settings, children: collectionCult.map((coll, index2) => {
        return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "px-2", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "bg-white", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
          ...
          lineNumber: 216,
          columnNumber: 17
        }, this) }, `cult_choose_${index2}`, false, {
          fileName: "app/routes/($locale)._index.jsx",
          lineNumber: 215,
          columnNumber: 22
        }, this);
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("a", { href: "/pages/about-us", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "my-[15px]", children: !isSmall ? /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
      "img",
      {
...
//# sourceMappingURL=/build/routes/($locale)._index-KTTCQIGQ.js.map
