...
} from "/build/_shared/chunk-ZXVCFRAK.js";
import {
  ProductCarousel_default
} from "/build/_shared/chunk-5O7KSPRK.js";
import {
  require_lib
...
var LooksComp = ({ looks }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "looks", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 sm:grid-cols-4 md:px-4 pb-4 lg:px-24", children: products.map((product, index) => {
      return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "relative", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Link, { reloadDocument: true, to: `/lookbook/${getProductId(product.node.id)}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("img", { src: product?.node.images.edges[0].node.url }, void 0, false, {
          fileName: "app/components/LooksComp.jsx",
          lineNumber: 18,
          columnNumber: 101
        }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/routes/($locale)._index-IVXRB3UY.js.map
