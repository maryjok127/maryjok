        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("section", { "aria-labelledby": "products-heading", className: "pb-12 pt-6", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4", children: [
            ...
            layout ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "lg:col-span-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-full max-w-screen-xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "cursor grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4", children: productsToShow.map((product, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "cursor mst-card-md", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
              ...
              lineNumber: 540,
              columnNumber: 17
            }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "lg:col-span-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-full max-w-screen-xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("table", { class: "table-auto  w-full", children: productsToShow.map((product, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("tbody", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("tr", { className: "cursor mst-card-md bg-white rounded-lg shadow-lg p-2 px-2 sm:px-2 mt-1", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("td", { onClick: () => goToProduct(`/products/${product.handle}`), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
                "img",
                {
                  src: product.images.edges[0]?.node?.url,
                  alt: product.title,
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("td", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "sm:text-lg text-[17px] xs:text-[14px] font-semibold mt-2 text-center w-[220px] min-h-[50px] xs:min-h-[65px] sm:min-h-[55px]", children: product.title }, void 0, false, {
                fileName: "app/routes/($locale).collections.$handle.jsx",
                lineNumber: 654,
                columnNumber: 29
              }, this) }, void 0, false, {
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("td", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "text-center sm:text-[26px] text-[21px] xs:text-[19px] font-bold m-auto w-full", children: [
                "\u20B9",
                Math.trunc(product.priceRange.maxVariantPrice.amount),
                " \xA0 \xA0\xA0",
                product.variants.nodes[0].compareAtPrice?.amount ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("s", { className: "opacity-50 text-xl", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("td", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex justify-center pt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
                c,
                {
                  productId: product.id,
                  okendoStarRatingSnippet: product.OkendoStarRatingSnippet
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("td", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "px-1 py-1 flex items-center sm:flex-row gap-3 justify-center w-[100%]", children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-[25%] flex justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
                  "svg",
                  {
                    xmlns: "http://www.w3.org/2000/svg",
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-FOTBYQRC.js.map
