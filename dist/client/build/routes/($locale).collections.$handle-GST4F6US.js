...
function Ne(t17, e4) {
  ...
  let D5 = (0, import_react27.useRef)(null), Q4 = y2(D5, e4), f10 = n2(D5), N6 = t17.hasOwnProperty("open") || a12 !== null, U4 = t17.hasOwnProperty("onClose");
  if (!N6 && !U4)
  ...
  let p6 = n6 ? 0 : 1, [S9, Z4] = (0, import_react27.useReducer)(Be, { titleId: null, descriptionId: null, panelRef: (0, import_react27.createRef)() }), P4 = o4(() => l12(false)), W2 = o4((r8) => Z4({ type: 0, id: r8 })), L2 = l3() ? g6 ? false : p6 === 0 : false, F6 = m10 > 1, Y4 = (0, import_react27.useContext)(I4) !== null, [ee2, te2] = ae(), { resolveContainers: M7, mainTreeNodeRef: k2, MainTreeNode: oe3 } = j3({ portals: ee2, defaultContainers: [(X4 = S9.panelRef.current) != null ? X4 : D5.current] }), re2 = F6 ? "parent" : "leaf", $4 = a12 !== null ? (a12 & d5.Closing) === d5.Closing : false, ne2 = (() => Y4 || $4 ? false : L2)(), le3 = (0, import_react27.useCallback)(() => {
    var r8, c13;
  ...
  let [ue2, fe2] = M2(), ge3 = (0, import_react27.useMemo)(() => [{ dialogState: p6, close: P4, setTitleId: W2 }, S9], [p6, S9, P4, W2]), J3 = (0, import_react27.useMemo)(() => ({ open: p6 === 0 }), [p6]), Te2 = { ref: Q4, id: i6, role: "dialog", "aria-modal": p6 === 0 ? true : void 0, "aria-labelledby": S9.titleId, "aria-describedby": ue2 };
...
var Q3 = { [0]: (e4) => ({ ...e4, disclosureState: u(e4.disclosureState, { [0]: 1, [1]: 0 }) }), [1]: (e4) => e4.disclosureState === 1 ? e4 : { ...e4, disclosureState: 1 }, [4](e4) {
...
function De3(t17, n6) {
  ...
  return z4 ? R3 = { ...R3, className: t6(i6.className, ...k2.current.enter, ...k2.current.enterFrom) } : (R3.className = t6(i6.className, (Q4 = e4.current) == null ? void 0 : Q4.className), R3.className === "" && delete R3.className), import_react33.default.createElement(M6.Provider, { value: A }, import_react33.default.createElement(c6, { value: u(l12, { ["visible"]: d5.Open, ["hidden"]: d5.Closed }) | H5.flags }, X({ ourProps: me3, theirProps: R3, defaultTag: ye3, features: ae2, visible: l12 === "visible", name: "Transition.Child" })));
}
function He2(t17, n6) {
...
var CollectionCarousel = ({ collection, handle, sortArr, all_collections }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "recommended_section w-full max-w-screen-xl mx-auto lg:px-52 sm:px-32 md:px-32", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react_slick.default, { ...settings, children: collectionsToShow.map((coll, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: coll.length ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full cursor", onClick: () => goToCollection(coll[0]?.node?.handle), children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white mst-card rounded-lg shadow-lg mx-2 p-1 sm:p-2", children: [
...
var meta = ({ matches, data }) => {
  ...
  return Go(...matches.map((match) => metaD));
};
var sortOptions = [
...
function Collection() {
  ...
  const [mobileFiltersOpen, setMobileFiltersOpen] = (0, import_react34.useState)(false);
  var productsToShow1 = [];
  const lines = [];
  const [startIndex, setStartIndex] = (0, import_react34.useState)(0);
  const [layout, setLayout] = (0, import_react34.useState)(true);
  const [productsToShow, setProductToShow] = (0, import_react34.useState)([]);
  const [productsToShowDump, setProductToShowDump] = (0, import_react34.useState)([]);
  const [imgUrl, setImgUrl] = (0, import_react34.useState)("");
  ...
  const [readMore, setMore] = (0, import_react34.useState)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(import_jsx_dev_runtime2.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "bg-white mx-2.5", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(tt.Root, { show: mobileFiltersOpen, as: import_react36.Fragment, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
        _t,
        {
          as: "div",
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("section", { className: "collectionContent sm:mt-4 overflow-auto", children: sortArr.length ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(CollectionCarousel_default, { collections: collection, handle, sortArr: sortColl }, void 0, false, {
        fileName: "app/routes/($locale).collections.$handle.jsx",
        lineNumber: 372,
        columnNumber: 14
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("main", { className: "mx-auto max-w-8xl px-0 sm:px-4 sm:px-6 lg:px-8", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("section", { "aria-labelledby": "products-heading", className: "pb-12 pt-6", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4", children: [
            ...
            layout ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "lg:col-span-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-full max-w-screen-xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "cursor grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4", children: productsToShow.map((product, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "cursor mst-card-md", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { onClick: () => goToProduct(`/products/${product.handle}`), children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "product_info", children: [
                      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "sm:text-lg text-[17px] xs:text-[14px] font-semibold mt-2 text-center min-h-[50px] xs:min-h-[65px] sm:min-h-[55px]", children: product.title }, void 0, false, {
                        fileName: "app/routes/($locale).collections.$handle.jsx",
                        lineNumber: 559,
                        columnNumber: 31
                      }, this),
                      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "text-center sm:text-[26px] text-[21px] xs:text-[19px] font-bold m-auto w-full", children: [
                        "\u20B9",
                        Math.trunc(product.priceRange.maxVariantPrice.amount),
                        " \xA0 \xA0\xA0",
                        product.variants.nodes[0].compareAtPrice?.amount ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("s", { className: "opacity-50 text-xl", children: [
                          "\u20B9",
                          ...
                          lineNumber: 568,
                          columnNumber: 35
                        }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("s", { className: "opacity-50 text-xl", children: [
                          "\u20B9",
                          Math.trunc(product.priceRange?.maxVariantPrice.amount)
                        ] }, void 0, true, {
                          fileName: "app/routes/($locale).collections.$handle.jsx",
                        ...
                        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("b", { className: "ml-2 text-red-500 text-sm xs:text-sm sm:text-xl", children: [
                          " (",
                          calculatePer(product.priceRange.minVariantPrice.amount, product.variants.nodes[0].compareAtPrice?.amount),
                          " % Off) "
                        ] }, void 0, true, {
                          fileName: "app/routes/($locale).collections.$handle.jsx",
                          lineNumber: 576,
                    ...
                    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex justify-center pt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
                      c,
                      {
              ...
              //List View
              /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "lg:col-span-3", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-full max-w-screen-xl", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-full", children: productsToShow.map((product, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "cursor flex items-center mst-card-md bg-white rounded-lg shadow-lg p-2 px-2 sm:px-2 mt-1", children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-1/3 sm:w-1/5", onClick: () => goToProduct(`/products/${product.handle}`), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
                  "img",
                  {
                    src: product.images.edges[0]?.node?.url,
                    alt: product.title,
                ...
                /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-2/3 sm:w-full sm:flex", children: [
                  /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex-initial w-full text-left sm:text-center sm:w-1/3 sm:text-lg text-[17px] xs:text-[14px] font-semibold mt-2 w-full sm:w-[220px] min-h-[50px] xs:min-h-[unset] sm:min-h-[55px]", children: product.title }, void 0, false, {
                    fileName: "app/routes/($locale).collections.$handle.jsx",
                    lineNumber: 654,
                    columnNumber: 27
                  }, this),
                  /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex-initial w-full sm:w-1/2 text-left sm:text-center sm:text-[26px] text-[21px] xs:text-[19px] font-bold m-0 sm:m-auto", children: [
                    Math.trunc(product.priceRange.maxVariantPrice.amount),
                    " \xA0\xA0",
                    product.variants.nodes[0].compareAtPrice?.amount ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("s", { className: "opacity-50 text-xl", children: [
                      "\u20B9",
                    ...
                    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("b", { className: "ml-2 text-red-500 text-left text-sm xs:text-sm sm:text-xl", children: [
                      " (",
                      calculatePer(product.priceRange.minVariantPrice.amount, product.variants.nodes[0].compareAtPrice?.amount),
                      " % Off) "
                    ] }, void 0, true, {
                  ...
                  /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex-initial w-full sm:w-1/5 justify-center pt-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
                    c,
                    {
                      productId: product.id,
                      okendoStarRatingSnippet: product.OkendoStarRatingSnippet
                  ...
                  /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-full sm:w-1/2 px-1 py-1 flex items-center sm:flex-row gap-3 justify-center w-[100%]", children: [
                    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "w-[25%] flex justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
                      "svg",
                      {
                        xmlns: "http://www.w3.org/2000/svg",
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "collection_desc", children: [
          !readMore ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("p", { dangerouslySetInnerHTML: { __html: `${collection?.descriptionHtml.slice(0, 450)}...` }, className: "my-4" }, void 0, false, {
            fileName: "app/routes/($locale).collections.$handle.jsx",
            lineNumber: 734,
            columnNumber: 15
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-GST4F6US.js.map
