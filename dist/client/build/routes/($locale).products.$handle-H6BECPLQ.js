    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
      $r,
      {
        ...
        children: ({ option }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
          ...
          {
            option,
            optionValues: option[0].optionValues,
            activeImg,
            closeRef,
            selectedVariant,
            setActiveImage
...
function ProductOptions({ option, optionValues, activeImg, closeRef, setActiveImage, selectedVariant }) {
  ...
  console.log("----option ::", optionValues.swtach.name);
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "product-options-grid items-center", children: option.values.map(({ value, isAvailable, isActive, to }, index) => {
      return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: { backgroundColor: "" }, children: " " }, void 0, false, {
              fileName: "app/routes/($locale).products.$handle.jsx",
              lineNumber: 608,
              columnNumber: 15
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { className: "color-swatch", src: `https://cdn.shopify.com/s/files/1/0809/4253/0882/files/${value}.png`, alt: value }, void 0, false, {
              fileName: "app/routes/($locale).products.$handle.jsx",
              lineNumber: 609,
              columnNumber: 15
            }, this)
...
//# sourceMappingURL=/build/routes/($locale).products.$handle-H6BECPLQ.js.map
